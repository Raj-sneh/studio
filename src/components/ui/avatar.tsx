...
const AvatarImage = ({ className, alt, src, ...props }: React.ImgHTMLAttributes<HTMLImageElement>) => {
  if (!src) return null;
  return <img className={cn("aspect-square h-full w-full", className)} alt={alt} src={src} {...props} />
}
