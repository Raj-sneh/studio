      ...
      <div className="space-y-16">
        ...
        <Card className="border-primary/20 bg-card/20 rounded-[2rem] overflow-hidden relative">
          ...
          <CardContent className="space-y-8 p-10 relative">
             ...
             <div className="max-w-xs mx-auto space-y-2 mb-4 grayscale opacity-40">
             ...
             <div className="flex flex-col sm:flex-row gap-4 justify-center grayscale opacity-40">
                <Button disabled size="lg" className="h-12 px-6 rounded-xl">
                    <Sparkles className="mr-2 h-4 w-4" /> Start Neural Training
                </Button>
                <Button disabled variant="outline" size="lg" className="h-12 px-6 rounded-xl">
        ...
        <div className="space-y-6 relative pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 grayscale opacity-30">
